...
def Bio():
    return html.div(
        ...
        html.p("When I'm not immersed in the world of technology, you can find me on the football pitch ⚽, where I enjoy the camaraderie and competition 💪🏾. Cooking is another creative outlet I indulge in, experimenting with flavors and techniques to create delightful culinary experiences. Anime, gaming and manga scenarios are where I can unwind and explore virtual worlds, allowing me to embrace new perspectives and narratives."),
